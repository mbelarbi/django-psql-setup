...
==========================
If you will be using PostgreSQL You need to install postgresql-server-dev-X.Y for building a server-side extension 
...
By defualt this will create the server on localhost port 8000 (http://127.0.0.1:8000/) you can specify which port
to run the server on by running:
